...
if __name__ == "__main__":
    ...
    parent_d='/docker-ros/local_ws/catkin_ws/src/babbling_playground/data'
    ...
    for i in range(epoch):
         robot.reset()
         observations={'tip':[],'joints':[],'actions':[],'goal':[]}
         
         dire=str(i)
         path=os.path.join(parent_d,dire)
         rand=np.random.randint(0,4)
         _,goal=robot.actions(rand)
         observations['goal'].append(goal)
